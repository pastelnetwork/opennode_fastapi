...
chmod 777 /apps
mkdir /apps/logs
mkdir /apps/logs/sense_api
mkdir /apps/logs/sense_api/app_log
# chmod 777 /apps/logs/weather_api
setfacl -m u:appuser:rwx /apps/logs/sense_api
# cd /apps
...
cp /apps/app_repo/new_pastel_testnet_faucet/server/units/pastel_testnet_faucet.service /etc/systemd/system/
